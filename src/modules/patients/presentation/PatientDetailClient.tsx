...
import { useUpdatePatient } from '@/lib/container';
...
export function PatientDetailClient({ patient: initialPatient }: Props) {
  ...
  const [state, dispatch] = useReducer(reducer, {
    ...
    age: initialPatient ? String(initialPatient.age) : '',
    ageErr: '',
  });
